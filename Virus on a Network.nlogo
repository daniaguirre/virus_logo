...
"" ""
PENS
"susceptible" 1 0 -13345367 true "" "plot (count turtles with [not infected? and not resistant?]) / (count turtles) * 100"
"infected" 1 0 -2674135 true "" "plot (count turtles with [infected?]) / (count turtles) * 100"
"resistant" 1 0 -7500403 true "" "plot (count turtles with [resistant?]) / (count turtles) * 100"
